...
const cards: CardData[] = [
  { id: "1", title: "CARD 1", frontContent: "Front 1", backContent: "This is content of the 1st card." },
  { id: "2", title: "CARD 2", frontContent: "Front 2", backContent: "This is content of the 2nd card." },
  { id: "3", title: "CARD 3", frontContent: "Front 3", backContent: "This is content of the 3rd card." },
  { id: "4", title: "CARD 4", frontContent: "Front 4", backContent: "This is content of the 4th card." },
];
...
const Card: React.FC<CardProps> = ({ 
  id, title, frontContent, backContent, index, totalCards, 
  isSpread, isFlipped, isHovered, onHover, onHoverEnd, onClick, flippedCard 
}) => {
  ...
  }, [isSpread, isFlipped, index, totalCards, controls, spreadX, baseX, stackRotation]);

  return (
    <motion.div
      className={twMerge('absolute w-[200px] h-[200px] cursor-pointer')}
      style={{ 
    ...
    >
      ...
      >
        ...
        <motion.div 
          className="absolute w-full h-full shadow-sm bg-gray-500 rounded-xl"
          style={{ 
            transform: 'translateZ(-1px)',
          }}
        />
        <motion.div 
          className="flex justify-center items-center absolute w-full h-full backface-hidden border b-[1px] border-neutral-100 bg-neutral-50 hover:bg-neutral-100 transition-colors shadow-sm rounded-xl p-4"
        ...
        <motion.div 
          className="absolute w-full h-full backface-hidden border b-[1px] border-neutral-100 shadow-md bg-white rounded-xl p-4"
          style={{ 
            backfaceVisibility: 'hidden',
            transform: 'rotateY(180deg) translateZ(3px)',
          }}
        >
          <h3 className="font-jbm text-neutral-700 text-lg font-bold">{title}</h3>
