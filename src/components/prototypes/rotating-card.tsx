...
const Card: React.FC<CardProps> = ({ 
  ...
  return (
    ...
    >
      ...
      >
        <motion.div 
          className="absolute w-full h-full backface-hidden border b-[1px] border-gray-200 bg-white shadow-sm rounded-xl p-4"
        ...
        <motion.div 
          className="absolute w-full h-full backface-hidden border b-[1px] border-blue-300 shadow-lg bg-blue-100 rounded-xl p-4"
          style={{ 
